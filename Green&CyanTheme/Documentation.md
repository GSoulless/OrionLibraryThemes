...
## Booting the Library
```lua
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/GSoulless/OrionLibraryThemes/refs/heads/main/Green&CyanTheme/Green&CyanTheme.lua')))()
```

## Making the Gui Transparent
```lua
-- transparent looks
